...
const API_USERS_URL = "http://api.mindssparsh.com/api/users";      // for users
const API_AUTH_URL = "http://api.mindssparsh.com/api/auth";        // unused currently
...
export const loginUser = async (credentials) => {
  const res = await fetch("http://api.mindssparsh.com/api/users/login", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
export async function sendOtp(data) {
  console.log(data);
  const res = await fetch('http://api.mindssparsh.com/api/users/send-otp', {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data)
  });

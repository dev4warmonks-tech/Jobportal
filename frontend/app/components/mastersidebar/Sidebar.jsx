...
export default function Sidebar() {
  ...
  const menu = [
    ...
    { name: "Experience", path: "/master/experience" },
    { name: "Sort By Date", path: "/master/sortbydate" },
  ];

  return (
    <div className="w-64 bg-[#E2F4FA] text-black min-h-screen p-6">
          ...
          return (
            <Link key={item.path} href={item.path}>
              ...
              >
                ...
                <div
                  className={`w-7 h-7 flex items-center p-2 justify-center rounded-full
